...
public class CredentialsValidator {
    ...
    public CredentialsValidator(final @NotNull Configuration configuration, final @NotNull ExtensionConfig extensionConfig, final @NotNull MetricRegistry metricRegistry) {
    ...
    public void init() {
        ...
        configuration.addReloadCallback(new Configuration.ReloadCallback() {
            @Override
            public void onReload(final @Nullable FileAuthConfig oldConfig, final @NotNull FileAuthConfig newConfig) {
     ...
     */
    @Nullable
    public List<String> getRoles(final @NotNull String userName, final @NotNull ByteBuffer password) {
    ...
    public List<TopicPermission> getPermissions(final @NotNull String clientId, final @NotNull String userName, final @NotNull List<String> clientRoles) {
        ...
        final Lock readLock = rolesLock.readLock();
        readLock.lock();
        try {
    ...
    private TopicPermission toTopicPermission(final @NotNull String clientId, final @NotNull String userName, final @NotNull Permission permission) {
    ...
    private String getTopicFilter(final @NotNull String clientId, final @NotNull String userName, final Permission permission) {
